...
namespace crg {
	...
	class crgicoico : public contract {
	public:
		crgicoico(account_name self) :contract(self), allowedicos(_self, _self) {}
		...
		struct log {
			...
			EOSLIB_SERIALIZE(log, (logtime)(crgoracle)(exchangerate)(icostarttime)(icoendtime))
		};
		...
		struct purchase {
			...
			EOSLIB_SERIALIZE(purchase, (purchaser)(crgbought)(eospaid))
		};
		...
		// @abi action
		void setico(name crgoracle, uint32_t icostarttime, uint32_t icoendtime);
		...
		// @abi action
		void addpurchase(account_name purchaser, asset crgbought, asset eospaid);
...
//EOSIO_ABI(crg::crgicoico, (setapp)(setico)(addauser)(addausers)(delauser)(delall)(logdata)(dellogdata)(addpurchase))